...
public class UtilEx01 {
	...
	public static void main(String[] args) {
		...
		System.out.println();
//int[] a = { 0, 1, 2,, 5, 6, 7, 8, 9, 33, 33 }; sort는 정렬이라는 뜻임
		Arrays.sort(a);
		...
		System.out.println("배열a와 배열b가 같은가 : " + Arrays.equals(a, b));//equals는 값과 인덱스번호까지같은가
		System.out.println();

		int[] c = new int[5];
		//System.arraycopy( 배열1, 배열1의 복사시작번호, 배열2, 배열2의 복사시작번호, 복사길이)
		System.arraycopy(b, 1 , c, 0, 5);//b변수를 1번부터 5개를
		arrayPrint("c : ", c);
		System.out.println();
