...
//PUnit Unit1 Unit2 Unit3
class Unit3 extends Unit2 { int u3 = 5; }

public class CastingTest03 {
	public static void main(String[] args) {
		Unit2 unit1 = new Unit2();//10번지는 PUnit Unit1 Unit2
		Unit3 unit2 = new Unit3();//20번지는 PUnit Unit1 Unit2 Unit3
		
		int result = unit1.u + unit1.u1 + unit1.u2;//6
		int result1 = unit2.u + unit2.u1 + unit2.u2//6+5 11
			+ unit2.u3;
		System.out.println("1번: " + unit1.u + " + "
		+ unit1.u1 + " + " 
		+ unit1.u2 + " = " + result);
		System.out.println("2번: " + unit2.u + " + "
		+ unit2.u1 + " + " 
		+ unit2.u2 + " + " + unit2.u3 + " = " + result1);
		System.out.println("===============================");
		...
		System.out.println("2번: "+ (unit1 instanceof Unit3));
